...
class UserProfileCreate extends React.Component {
    ...
    componentDidMount() {
        console.log('this.props', this.props.match.params.userId)
    }
    ...
    handleSubmit(event) {
        ...
        authRequest('post', 'profile/create/',
            {
                user : parseInt(this.props.match.params.userId),
                user_type : parseInt(this.state.userTypeId),
                gender:this.state.gender,
                avater : this.state.avater,
                dob: this.state.dateOfBirth.format('YYYY-MM-DD'),
                phone : this.state.phone,
                delivery_method :parseInt(this.state.deliveryMethod),
                national_id : this.state.nationalId,
                specialization : this.state.specialization,
                description: this.state.description,
            }
        ).then((res) => {
            this.newToast('profile created', 'success') 
            ...
            if (error.response) {
                ...
                this.newToast('something is wrong', 'danger')
                // this.newToast(this.state.errorMsg, 'error') 
            } else {
                ...
                <div className="row top">
                    ...
                    <div className="centerDiv col-sm-12 form-elegant divShadow">
                        ...
                        <div className="titleColor">
                            <p className=" h1 text-center mb-4">Profile create</p>
                        </div>
    ...
    render() {
        return (
            <App content={this.renderProfileForm()} />
        )
    }
}
